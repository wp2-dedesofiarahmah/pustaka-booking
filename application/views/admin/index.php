...
<div class="container-fluid"> 
            ...
            <div class="card border-left-danger shadow h-100 py-2 bg-primary"> 
                <div class="card-body"> 
                    <div class="row no-gutters align-items-center"> 
                        <div class="col mr-2"> <div class="text-md font-weight-bold text-white text-uppercase mb-1">Jumlah Anggota</div> 
    ...
    <div class="col-xl-3 col-md-6 mb-4"> 
        ...
        <!-- row table--> 
        <div class="row"> <div class="table-responsive table-bordered col-sm-5 ml-auto mr-auto mt-2"> 
